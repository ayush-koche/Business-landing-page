...
const Hero = () => {
  const handleSubmit = (e) => {
    e.preventDefault();
    // simple demo - replace with actual logic
  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-1/2 space-y-8">
        ...
        >
          Get the most accurate leads, sales training, and conversion tools —
          all within one simple billing plan.
        </motion.p>
        ...
        >
          ...
          {/* Secondary CTA */}
          <button className="sm:w-auto w-full border border-gray-200 px-8 py-4 rounded-xl hover:bg-gray-50 transition-all">
            Learn More
          </button>
        </motion.div>
      </div>
      ...
      >
        <div className="relative">
          ...
          />
          {/* Floating background blob effect */}
          <div className="absolute -top-6 -right-6 w-40 h-40 bg-blue-100 rounded-full blur-3xl opacity-50 animate-pulse"></div>
        </div>
      </motion.div>
    </section>
  );
